...
def test_retry_with_x402_success(mock_wallet, mock_x402_requests, mock_decode_payment):
    ...
    mock_session = mock_x402_requests.return_value
    ...
    mock_decode_payment.assert_called_once_with("mock_payment_response")
...
def test_make_http_request_with_x402_success(
    mock_wallet, mock_x402_requests, mock_decode_payment
):
